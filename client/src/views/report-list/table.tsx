...
import { Report, ReportType, StatusType } from 'src/types/apps/reportTypes'
...
type TabelReportListProps = {
  reports: ReportType[] | undefined
}

export default function TableReportList(props: TabelReportListProps) {
  const { reports } = props
  ...
  // const [orderBy, setOrderBy] = React.useState<keyof Report>('createdAt')
  ...
  return (
    ...
    //                       {report.userId?.rankID ? report.userId?.rankID.toString() : 'No Rank'}
    //                     </Typography>
    //                   </Box>
    //                 </Box>
    //               </TableCell>
